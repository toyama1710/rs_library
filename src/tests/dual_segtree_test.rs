...
#[test]
fn test_assign() {
    use crate::data_structures::segment_tree::dual_segment_tree::DualSegmentTree;
    let n = 10000;
    ...
    for i in 19..60 { naive[i] = Some(70); }
